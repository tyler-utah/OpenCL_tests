...
// relaxing load acquire to load relaxed in this mutant
...
#if defined(NVIDIA)
  nv_atomic_store_explicit_seq_cst(a,v);
#else
  atomic_store_explicit(a, v, memory_order_seq_cst, memory_scope_device);
#endif
}
